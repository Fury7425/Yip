...
namespace winrt::yip::implementation
{
    ...
    winrt::hstring SettingsDialog::OutputFolder() const noexcept { ReadFromControls(); return m_outputFolder; }
    ...
    uint32_t SettingsDialog::SampleRate() const noexcept { ReadFromControls(); return m_sampleRate; }
    ...
    uint16_t SettingsDialog::Channels() const noexcept { ReadFromControls(); return m_channels; }
    ...
    void SettingsDialog::ApplyToControls()
    {
        ...
        if (SampleRateCombo()) {
            ...
            switch (m_sampleRate) {
                ...
                case 88200: idx = 2; break;
                case 96000: idx = 3; break;
                default: break;
            }
    ...
    void SettingsDialog::ReadFromControls() const
    {
        ...
        if (SampleRateCombo()) {
            switch (SampleRateCombo().SelectedIndex()) {
                case 0: self->m_sampleRate = 44100; break;
                case 1: self->m_sampleRate = 48000; break;
                case 2: self->m_sampleRate = 88200; break;
                case 3: self->m_sampleRate = 96000; break;
                default: break;
            }
        }
        if (ChannelsCombo()) {
