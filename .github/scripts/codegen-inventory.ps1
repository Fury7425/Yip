...
if (-not (Test-Path $dir)) {
    Write-Output "no '$dir' — codegen produced nothing"
    exit 1
}

Write-Output '--- generated sources (top level) ---'
Get-ChildItem $dir -File | Select-Object -ExpandProperty Name | Sort-Object | ForEach-Object { Write-Output $_ }

Write-Output '--- module entry points ---'
