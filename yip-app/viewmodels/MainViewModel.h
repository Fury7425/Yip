...
namespace winrt::yip::viewmodels::implementation
{
    ...
    {
        DeviceEntry() = default;
        DeviceEntry(winrt::hstring id, winrt::hstring name, winrt::hstring glyph,
                    bool isCapture, bool isDefault)
            : m_id(std::move(id))
    ...
    struct RecordingEntry : RecordingEntryT<RecordingEntry>
    {
        ...
        RecordingEntry(winrt::hstring fullPath, winrt::hstring fileName,
                       winrt::hstring duration, winrt::hstring modifiedAt)
    ...
    struct MainViewModel : MainViewModelT<MainViewModel>
    {
        ...
        winrt::Windows::Foundation::Collections::IObservableVector<
            winrt::yip::viewmodels::DeviceEntry> Devices() const noexcept { return m_devices; }
        winrt::Windows::Foundation::Collections::IObservableVector<
            winrt::yip::viewmodels::RecordingEntry> Recordings() const noexcept { return m_recordings; }
    ...
    private:
        ...
        winrt::Windows::Foundation::Collections::IObservableVector<
            winrt::yip::viewmodels::DeviceEntry> m_devices{
                winrt::single_threaded_observable_vector<winrt::yip::viewmodels::DeviceEntry>() };
        winrt::Windows::Foundation::Collections::IObservableVector<
            winrt::yip::viewmodels::RecordingEntry> m_recordings{
                winrt::single_threaded_observable_vector<winrt::yip::viewmodels::RecordingEntry>() };
