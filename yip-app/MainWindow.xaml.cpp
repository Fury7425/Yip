...
namespace winrt::yip::implementation
{
    MainWindow::MainWindow()
    {
        ...
        m_deviceWatcher = std::make_unique<::yip::interop::DeviceWatcher>(
        ...
        winrt::Microsoft::UI::Xaml::WindowActivatedEventArgs const& args)
    {
        ...
        if (m_pollTimer) {
            m_pollTimer.Interval(m_focused ? std::chrono::milliseconds(16)
    ...
    winrt::fire_and_forget MainWindow::OnOpenSettings(
        winrt::Windows::Foundation::IInspectable const& /*sender*/,
        winrt::Microsoft::UI::Xaml::RoutedEventArgs const& /*args*/)
    {
        ...
        {
            strong->m_viewModel.ApplySettings(
                dialog.OutputFolder(),
                dialog.SampleRate(),
                dialog.Channels());
        }
    ...
    void MainWindow::OnRecordingClicked(
        winrt::Windows::Foundation::IInspectable const& /*sender*/,
